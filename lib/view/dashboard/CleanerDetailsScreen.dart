...
import 'package:public_hospital/viewModel/dashboard/CleanerDetailsViewModel.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      CircleAvatar(
                        radius: 50,
                        backgroundImage:
                            vm.cleaner.imageUrl != null &&
                                vm.cleaner.imageUrl!.isNotEmpty
                            ? NetworkImage(vm.cleaner.imageUrl!)
                            : const AssetImage(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              _buildDetailRow(
                                icon: Icons.phone,
                                value: vm.cleaner.phone,
                              ),
                              _buildDetailRow(
                                icon: Icons.email,
                                value: vm.cleaner.email,
                              ),
                              _buildDetailRow(
                                icon: Icons.location_on,
                                value: vm.cleaner.address,
                              ),
                              _buildDetailRow(
                                icon: Icons.cake,
                                value: formattedDate,
                              ...
                              _buildDetailRow(
                                icon: Icons.school,
                                value: vm.cleaner.institute,
                              ),
                              _buildDetailRow(
                                icon: Icons.workspace_premium,
                                value: vm.cleaner.degree,
                              ),
                            ],
                          ),
                        ),
