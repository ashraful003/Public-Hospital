...
class PharmaceuticalRegisterViewModel extends ChangeNotifier {
  ...
  PharmaceuticalRegisterViewModel() {
    _addListeners();
  }
  ...
  Future<bool> register(BuildContext context) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Pharmaceutical Registered")),
      );
      clear();
      return true;
    } catch (e) {
